...
public class ItemListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(ContentList.ITEMS));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        public final List<Currency> mValues;
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
                ...
                String mDrawableName = mValues.get(position).getCode().toLowerCase() + "_flag";
                int resID = res.getIdentifier(mDrawableName, "drawable", getPackageName());
                Drawable drawable = res.getDrawable(resID);
                holder.mImage.setImageDrawable(drawable);
                holder.mContentView.setText(mValues.get(position).getName() + " (" + mValues.get(position).getCode() + ")");
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                mImage = (ImageView) view.findViewById(R.id.flag);
            }
         }
    }
